...
public class PreviewWriteProAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
//		System.out.println("previewWriteProAction!");
...
//		System.out.println("썸네일 :  " + thumbnail );
		...
		previewBean.setMember_id(multi.getParameter("member_id"));
		previewBean.setSubject(multi.getParameter("subject"));
		previewBean.setContent(multi.getParameter("content"));
		previewBean.setFile(multi.getOriginalFileName("file"));
		previewBean.setThumbnail(multi.getOriginalFileName("thumbnail"));
		
		Timestamp date = new Timestamp(System.currentTimeMillis());
		previewBean.setDate(date);
		...
		PreviewWriteProService previewWriteProService = new PreviewWriteProService();
		boolean isWriteSuccess = previewWriteProService.registArticle(previewBean);
		...
		if(!isWriteSuccess) {
			...
			forward.setPath("PreviewList.pr");
