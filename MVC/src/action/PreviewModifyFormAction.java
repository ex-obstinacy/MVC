...
import svc.PreviewDetailService;
import vo.ActionForward;
import vo.PreviewBean;


public class PreviewModifyFormAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// 특정 게시물 수정을 위해 기존 게시물 정보를 요청하는 Action 클래스
		System.out.println("PreviewModifyFormAction");
		...
		PreviewDetailService previewDetailService = new PreviewDetailService();
		PreviewBean article = previewDetailService.getArticle(num);
...
//		System.out.println(article.getContent());
		...
		forward.setPath("/preview/preview_modify.jsp");
