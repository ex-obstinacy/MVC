...
import svc.WinListService;
import vo.ActionForward;
import vo.NoticeBean;
import vo.PageInfo;
import vo.WinBean;

public class WinListAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		
		System.out.println("WinListACtion");
		...
		WinListService winListService = new WinListService();
		int listCount = winListService.getListCount();
		
		ArrayList<WinBean> articleList = new ArrayList<WinBean>();
		
		articleList = winListService.getArticleList(page, limit);
		...
		forward.setPath("/win/win_list.jsp");
