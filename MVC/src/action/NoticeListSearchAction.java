...
public class NoticeListSearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("NoticeListSearchAction");
		...
		int listCount = noticeListSearchService.getListCount(search);
//		System.out.println("전체 게시물 수 : " + listCount);
		...
		articleList = noticeListSearchService.getArticleList(page, limit, search);
		...
		forward.setPath("/notice/notice_listSearch.jsp");
