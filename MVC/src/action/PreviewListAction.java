...
import svc.PreviewListService;
import vo.ActionForward;

import vo.PageInfo;
import vo.PreviewBean;

public class PreviewListAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		
		
		System.out.println("PreviewListAction");
		...
		PreviewListService previewListService = new PreviewListService();
		int listCount = previewListService.getListCount();
//		System.out.println("전체 게시물 수 : " + listCount);
		...
		articleList = previewListService.getArticleList(page, limit);
		...
		forward.setPath("/preview/preview_list.jsp");
