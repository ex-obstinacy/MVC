...
import svc.EventListSearchService;
...
public class EventListSearchAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("EventListSearchAction");
		...
		EventListSearchService eventListSearchService = new EventListSearchService();
		int listCount = eventListSearchService.getListCount(search);
//		System.out.println("전체 게시물 수 : " + listCount);
		...
		articleList = eventListSearchService.getArticleList(page, limit, search);
		...
		forward.setPath("/event/event_listSearch.jsp");
