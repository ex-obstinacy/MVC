		...
		<div class="container">
			<div class="inr02">
				...
				<div class="col-md-10 col-md-push-2">
					<h3>시사회/무대인사 게시판 글쓰기</h3>
					<div class="block" style="padding-top: 5px;">
						<div class="row" style="min-height: 500px;">
							<!-- 게시판 -->
							<div class="bbs-view m_noview">
								<section id="writeForm">
									<form action="PreviewModifyPro.pr" method="post" enctype="multipart/form-data" name="modifyForm">
										...
										<table>
											...
											<tbody>
												...
												<tr>
													...
													<td class="bbs-list-b" colspan="4">
														<textarea id="editor1" name="content" style="width: 800px; height: 500px; resize: none;"><%=article.getContent()%>
												</textarea>
													</td>
												</tr>
											</tbody>
