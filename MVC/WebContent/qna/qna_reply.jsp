									...
									<form action="QnaReplyPro.qn" method="post" name="replyForm">
										...
										<table>
											...
											<tbody>
												...
												<!-- 											<td class="bbs-list-b"><input type="file" name="file" placeholder="파 일" class="form-control" value="" readonly></td> -->
												<!-- 											<td class="bbs-list-blank"></td> -->
												<!-- 										</tr> -->
												<tr>
													<td class="bbs-list-blank"></td>
													<td class="bbs-list-a">본 문</td>
													<td class="bbs-list-b" colspan="4"><textarea id="editor1" name="content" style="width: 800px; height: 500px; resize: none;" required="required"></textarea></td>
												</tr>
											</tbody>
