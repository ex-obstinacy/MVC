		...
		<article>
			...
			<form action="MemberWritePro.me" id="join" method="post" name="fr">
				<fieldset>
					...
					<label>비밀번호 재확인</label> <input type="password" name="rePass" id="rePass" required="required"><br>
					...
					<label>성별</label> <input type="radio" name="gender" value="male" id="male">남 <input type="radio" name="gender" value="female" id="female">여<br>
