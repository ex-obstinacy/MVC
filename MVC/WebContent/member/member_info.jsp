						...
						<aside class="left_widgets p_filter_widgets">
							...
							<div class="side_menu">
								...
								<ul class="list side_list">
									...
									<li class="active"><a href="MemberInfo.me">My 정보</a></li>
...
<!-- 											<td class=td_size>아이디</td> -->
										...
										<tr>
											...
											<td><input type="radio" name="gender" value="male"
												...
												<%if (article.getGender().equals("female")) {%>
												checked="checked" <%}%>>여</td>
										</tr>
										<tr>
											<td>생년월일</td>
											<td><input type="date" name="birthday" id="birthday"
												required="required" value="<%=article.getBirthday()%>"></td>
										</tr>
									</table>
								</fieldset>
								<fieldset>
...
<!-- 											<td rowspan="3" class=td_size>주소</td> -->
										...
										<tr>
											<td><input type="text" name="detailAddress"
												...
												placeholder="참고항목" value="<%=article.getExtraAddress()%>"
