						...
						<div class="row" style="min-height:500px;">
							...
							<div class="bbs-document-wrap" itemscope itemtype="http://schema.org/Article">
								...
								<div class="bbs-detail">
									...
									%> <a href="notice/file_down.jsp?downFile=<%=article.getFile()%>"><%=article.getFile() %></a> <%
									}
									%>
...
<!-- 								</div> -->
							...
							<div class="bbs-control">
								<div style="text-align:center;">
									<a href="NoticeList.no?page=<%=nowPage%>" target="_parent" class="bbs-button">목록보기</a> 
																	</div>
								<%
									if(Member_id!=null){
										if(Member_id.equals("admin")){%>
											<div style="text-align:center;">
												<a href="NoticeModifyForm.no?num=<%=article.getNum()%>&page=<%=nowPage%>" target="_parent" class="bbs-button">수정하기</a> 
																	</div>
...
<script type="text/javascript">
	...
	<form action="NoticeDeletePro.no" name="fr" method="post">
	<input type="hidden" name="num" value="<%=num %>" />
	<input type="hidden" name="page" value="<%=nowPage %>" />
	<input type="submit" value="삭제하기" onclick="return a()">
		</form>
